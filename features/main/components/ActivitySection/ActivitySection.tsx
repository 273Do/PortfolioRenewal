...
const ActivitySection = async () => {
  return (
    <>
      <div className="relative z-[100] bg-background px-3 pt-0 sm:px-12">
        <div className="sticky top-0 z-20 w-full bg-background">
          <div className="h-32 px-3"></div>
          <SectionTitle />
        </div>
        <div className="mb-5 flex w-full items-start justify-between px-2 text-xs sm:mb-10 sm:text-base">
          <ul>
      ...
      <p className="z-100 relative mx-2 w-full p-3 pt-0 sm:w-3/5 sm:p-12">
